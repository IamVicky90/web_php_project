                        ...
                        <div class="wrapper fadeInDown ">
                            <div id="formContent">
                                ...
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <input type="text" pattern="[0-9]+" id="productprice" class="fadeIn secound" name="productprice" placeholder="Product price *"><br>
                                    <input type="text" pattern="[0-9]+" id="productdiscount" class="fadeIn third" name="productdiscount" placeholder="Product discount *"><br>
                                    <input type="text" pattern="[0-9]+" id="productsize" class="fadeIn fourth" name="productsize" placeholder="Product serving *"><br>
